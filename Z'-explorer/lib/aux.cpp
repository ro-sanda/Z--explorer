...
void savew(double *matrix,char headers[13][22], int num,int option,int rows,int columns){    
...
void savebr(double *matrix,char headers[10][22], int num,int option,int rows,int columns){    
