...
GC_10 = Coupling(name = 'GC_10',
                 value = '-12*cw**2*ee**2*complex(0,1)',
                 order = {'QED':2})
...
GC_14 = Coupling(name = 'GC_14',
                 value = '-(complex(0,1)*gZpbL)/2.',
                 order = {'NP':1})

GC_15 = Coupling(name = 'GC_15',
                 value = '(complex(0,1)*gZpbR)/2.',
                 order = {'NP':1})

GC_16 = Coupling(name = 'GC_16',
                 value = '-(complex(0,1)*gZpcL)/2.',
                 order = {'NP':1})

GC_17 = Coupling(name = 'GC_17',
                 value = '(complex(0,1)*gZpcR)/2.',
                 order = {'NP':1})

GC_18 = Coupling(name = 'GC_18',
                 value = '-(complex(0,1)*gZpdL)/2.',
                 order = {'NP':1})

GC_19 = Coupling(name = 'GC_19',
                 value = '(complex(0,1)*gZpdR)/2.',
                 order = {'NP':1})

GC_20 = Coupling(name = 'GC_20',
                 value = '-(complex(0,1)*gZpsL)/2.',
                 order = {'NP':1})

GC_21 = Coupling(name = 'GC_21',
                 value = '(complex(0,1)*gZpsR)/2.',
                 order = {'NP':1})

GC_22 = Coupling(name = 'GC_22',
                 value = '-(complex(0,1)*gZptL)/2.',
                 order = {'NP':1})

GC_23 = Coupling(name = 'GC_23',
                 value = '(complex(0,1)*gZptR)/2.',
                 order = {'NP':1})

GC_24 = Coupling(name = 'GC_24',
                 value = '-(complex(0,1)*gZpuL)/2.',
                 order = {'NP':1})

GC_25 = Coupling(name = 'GC_25',
                 value = '(complex(0,1)*gZpuR)/2.',
                 order = {'NP':1})
...
GC_68 = Coupling(name = 'GC_68',
                 value = '(-12*cw**4*ee**2*complex(0,1))/sw**2',
                 order = {'QED':2})
...
GC_90 = Coupling(name = 'GC_90',
                 value = '(-12*cw**3*ee**2*complex(0,1))/sw',
                 order = {'QED':2})
...
GC_116 = Coupling(name = 'GC_116',
                  value = '(ee**2*vev)/2. + (cw**2*ee**2*vev)/(4.*sw**2) + (ee**2*sw**2*vev)/(4.*cw**2)',
                  order = {'QED':1})
