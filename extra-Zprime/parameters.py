...
gZptL = Parameter(name = 'gZptL',
                  nature = 'external',
                  type = 'real',
                  value = 0,
                  texname = '\\text{gZp}_{\\text{tL}}',
                  lhablock = 'FRBlock',
                  lhacode = [ 1 ])

gZptR = Parameter(name = 'gZptR',
                  nature = 'external',
                  type = 'real',
                  value = 1,
                  texname = '\\text{gZp}_{\\text{tR}}',
                  lhablock = 'FRBlock',
                  lhacode = [ 2 ])

gZpbL = Parameter(name = 'gZpbL',
                  nature = 'external',
                  type = 'real',
                  value = 0,
                  texname = '\\text{gZp}_{\\text{bL}}',
                  lhablock = 'FRBlock',
                  lhacode = [ 3 ])

gZpbR = Parameter(name = 'gZpbR',
                  nature = 'external',
                  type = 'real',
                  value = 1,
                  texname = '\\text{gZp}_{\\text{bR}}',
                  lhablock = 'FRBlock',
                  lhacode = [ 4 ])

gZpcL = Parameter(name = 'gZpcL',
                  nature = 'external',
                  type = 'real',
                  value = 0,
                  texname = '\\text{gZp}_{\\text{cL}}',
                  lhablock = 'FRBlock',
                  lhacode = [ 5 ])

gZpcR = Parameter(name = 'gZpcR',
                  nature = 'external',
                  type = 'real',
                  value = 1,
                  texname = '\\text{gZp}_{\\text{cR}}',
                  lhablock = 'FRBlock',
                  lhacode = [ 6 ])

gZpsL = Parameter(name = 'gZpsL',
                  nature = 'external',
                  type = 'real',
                  value = 0,
                  texname = '\\text{gZp}_{\\text{sL}}',
                  lhablock = 'FRBlock',
                  lhacode = [ 7 ])

gZpsR = Parameter(name = 'gZpsR',
                  nature = 'external',
                  type = 'real',
                  value = 1,
                  texname = '\\text{gZp}_{\\text{sR}}',
                  lhablock = 'FRBlock',
                  lhacode = [ 8 ])
